...
**Current close status: WSL, Windows and macOS complete; Linux incomplete.**
...
WSL. Linux and native Windows still owe their affected reruns.
...
| B09 | Client owns targets; second client stays connected | Break the first socket, reconnect inside 30 seconds, then repeat after heartbeat and grace expiry | Timely reconnect restores state; expired leases become orphaned and are explicitly reclaimable | Streams and monotonic timing; release reclaimed state | pass: repaired candidate restored the 8.032-second cut; 46.063-second cut orphaned leases before explicit claims | blocked: the 11.627-second reconnect retained its lease, but VM scheduling delayed the 46-second relay restoration to 64.606 seconds and the strict 55-second controller rejected that leg | pass: 8.031-second cut retained the lease; 46.031-second cut expired it for explicit reclaim | pass: an 8.081-second cut reconnected in 8.112 seconds and retained the lease; the 46.057-second cut expired it for explicit reclaim at bf92090 |
...
**Current verdict: WSL, Windows and macOS complete; Linux remains incomplete.**
...
reopened on Linux, and Linux also retains its B09 scheduling
blocker. The macOS audit completed every reopened or affected cell
...
| B: shared broker and target ownership | pass: B07 reran at 2845224/bf92090; other accepted results retained | blocked: B07 rerun owed; B09 scheduling blocker retained | pass: B07 reran at 785df68/bf92090; other accepted results retained | pass: B06-B10 reran at bf92090; unaffected observations retained |
| C: actionability and browser typing | pass: C06 reran at 2845224/bf92090; unaffected cells retained | blocked: C06 rerun owed; unaffected cells retained | pass: C06 reran at 785df68/bf92090; unaffected cells retained | pass: C06 reran at bf92090; unaffected observations retained |
...
| E: packaged and clean delivery | pass: E01 fresh installed-artifact verification at 2845224/bf92090 | blocked: E01 fresh artifact verification owed | pass: E01 fresh installed-artifact verification at 785df68/bf92090 | pass: fresh E01 installed-artifact verification at bf92090; unaffected observations retained |
| F: final audit regressions | pass: F05 reran at 2845224/bf92090; other accepted results retained | blocked: F05 rerun owed; other accepted results retained | pass: F05 reran at 785df68/bf92090; other accepted results retained | pass: F03-F05 and F07 reran at bf92090; unaffected observations retained |
| overall | pass: all 42 applicable cells have accepted observations; 5 cells retain their Not-Needed reasons | blocked: E01/B07/C06/F05 reopened; B09 environment blocker retained | pass: all 41 applicable cells have accepted observations; 6 cells retain their Not-Needed reasons | pass: all 32 applicable cells have accepted observations; 15 cells are Not-Needed with retained reasons |

The native Linux audit used branch head
`d794ad1a7f52fd666ccd1a58478d9f3bd230ede5` and a fresh noneditable wheel
with SHA-256
`beb3d064dd9baba1777ef00a6816c3ad07df1057b1b81d18fe95e24f32f870e7`.
The 8-second B09 cut restored after 8.050 seconds and opened a real relay
connection 11.627 seconds after the cut, preserving the lease and both exact
documents. On the expiry leg, the relay received the exact 46-second command,
but host scheduling delayed its restoration event until 64.606 seconds. The
55-second controller therefore exited nonzero as designed. The later orphan,
reclaim and stale-action semantics passed F03, but the rejected controller
prevents B09 from receiving a pass. No product defect is inferred from that
host-timing failure.
