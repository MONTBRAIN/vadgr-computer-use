...
|---|---|---|---|---|
| A: recovery and setup diagnosis | incomplete: A03 redirected-local-appdata rerun owed; prior observations retained | pass: repaired-artifact A01-A04 observed; VM save/resume scope applies | incomplete: A01, A03 and A04 passed; A02 was approved and its suspend ran, but its single gated read needs one driver session spanning the suspend and the owner declined a second one | pass: A01-A04 observed; A02 retained the original document after verified sleep and full wake |
