...
| id | precondition and setup | action or goal | expected observable and oracle | evidence and cleanup | WSL | Linux | Windows | macOS |
|---|---|---|---|---|---|---|---|---|
| B01 | One profile; two independent MCP clients | Attach both clients and list profiles, windows, and tabs | Both remain connected through one broker and see one complete registry | Both JSON streams and broker identity | pass: independent WSL and Windows clients shared one broker and caller-specific registry at 747b6fb | pass: two independent clients share one broker and complete registry with caller-specific target labels at 17fbe37 | pass: two independent clients shared one complete broker identity and registry at 86fe6f1 | pass: two independent clients shared one broker and registry with caller-specific target labels |
...
| B: shared broker and target ownership | incomplete: heartbeat-EOF B09, B10 and B15 reruns owed | pass: repaired-wheel ownership, reconnect and broker replacement observed | incomplete: heartbeat-EOF B09, B10 and B15 reruns owed | pass: repaired-artifact mutation metadata, reconnect and broker replacement observed |
...
| E: packaged and clean delivery | incomplete: repaired-artifact E01 and E03 owed | pass: repaired noneditable wheel, readiness, segmenter and profile verified | incomplete: heartbeat-EOF repaired-artifact E01 owed | pass: repaired noneditable wheel, readiness, segmenter and fitted profile verified |
| overall | incomplete: A03, B09, B10, B15, E01 and E03 reruns owed | pass: all 30 applicable Linux cells passed; 16 Not-Needed cells retain reasons; evidence pushed and isolated test state removed | incomplete: A02 owner-deferred; B09, B10, B15 and E01 repaired-artifact reruns owed | pass: all 32 applicable macOS cells passed; 14 Not-Needed cells retain reasons; evidence pushed and isolated test state moved to recoverable Trash |
