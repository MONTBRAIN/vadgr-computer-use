...
| Native input permission | D01-D06 where applicable, E02 pixel path | Grant only the normal OS accessibility or input permission |
| Stock plain-text editor | D01-D06 where applicable, E02 pixel path | Keep Windows Notepad, macOS TextEdit, or the host's stock Linux text editor available; install no editor solely for these cells |
...
| D: pixel typing | pass | pass | pass | partial: prior observations retained; D01-D06 reruns and new modifier-chord proof owed after the macOS keyboard-source repair |
| E: packaged and clean delivery | incomplete: E01 identity on the repaired package | incomplete: E01 identity on the repaired package | incomplete: E01 identity on the repaired package | partial: browser delivery proof retained; repaired package identity and pixel long-input rerun owed |
| overall | incomplete: setup and recovery reruns remain | incomplete: setup and recovery reruns remain | incomplete: setup and recovery reruns remain | partial: A02 sleep/wake, macOS keyboard repair reruns, D06 and final cleanup remain |
